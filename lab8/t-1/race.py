...
background_img = pygame.image.load("/home/dastan/KBTU/lab8/t-1/set/road_back.png").convert()
background_img = pygame.transform.scale(background_img, (WIDTH, HEIGHT))

player_img = pygame.image.load("/home/dastan/KBTU/lab8/t-1/set/car.png").convert_alpha()
player_img = pygame.transform.scale(player_img, (60, 80))
player_rect = player_img.get_rect(center=(WIDTH // 2, HEIGHT - 80))

enemy_img = pygame.image.load("/home/dastan/KBTU/lab8/t-1/set/enemy_car.png").convert_alpha()
enemy_img = pygame.transform.scale(enemy_img, (60, 80))

coin_img = pygame.image.load("/home/dastan/KBTU/lab8/t-1/set/coin.png").convert_alpha()
